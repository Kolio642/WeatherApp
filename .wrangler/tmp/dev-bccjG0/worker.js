(() => {
  ...
  // .wrangler/tmp/bundle-lkGghe/checked-fetch.js
...
`
  ...
  // .wrangler/tmp/bundle-lkGghe/middleware-insertion-facade.js
  ...
  (() => {
    ...
    var __webpack_modules__ = {
      ...
      "./src/handlers/api.js": (
        ...
        (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
          ...
          var _utils_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__2(
            /*! ../utils/fetch */
            "./src/utils/fetch.js"
          );
          ...
          async function handleWeatherRequest(queryParams, apiKey) {
            ...
            return await (0, _utils_fetch__WEBPACK_IMPORTED_MODULE_0__.fetchFromApi)(apiUrl);
          }
    ...
    (() => {
      ...
      var _handlers_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ./handlers/api */
        "./src/handlers/api.js"
      );
      var _handlers_assets__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        /*! ./handlers/assets */
        "./src/handlers/assets.js"
      );
      ...
      async function handleEvent(event) {
        ...
        try {
          if (path.startsWith("/api/")) {
            return await (0, _handlers_api__WEBPACK_IMPORTED_MODULE_0__.handleApiRequest)(event, WEATHER_API_KEY);
          }
          return await (0, _handlers_assets__WEBPACK_IMPORTED_MODULE_1__.serveStaticAsset)(event);
        } catch (e) {
